...
const editInstanceGroupSchema = z.object({
...
type EditInstanceGroupForm = z.infer<typeof editInstanceGroupSchema>;

interface EditInstanceGroupDialogProps {
  group: InstanceGroup;
  open: boolean;
...
export function EditInstanceGroupDialog({ group, open, onOpenChange, onSuccess }: EditInstanceGroupDialogProps) {
  ...
  const onSubmit = (data: EditInstanceGroupForm) => {

    // Sempre incluir description no payload
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Edite as informações do grupo de instâncias.
          </DialogDescription>
        </DialogHeader>
